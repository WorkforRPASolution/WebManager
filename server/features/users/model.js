...
const rolePermissionSchema = new Schema({
  ...
  permissions: {
    ...
    dashboardResStatus: { type: Boolean, default: true },
    dashboardResVersion: { type: Boolean, default: true },
    dashboardRecoveryOverview: { type: Boolean, default: true },
    dashboardRecoveryByProcess: { type: Boolean, default: true },
    dashboardRecoveryByModel: { type: Boolean, default: true },
    dashboardRecoveryAnalysis: { type: Boolean, default: true },
    dashboardRecoveryByCategory: { type: Boolean, default: true },
    dashboardUserActivity: { type: Boolean, default: true },
...
const DEFAULT_ROLE_PERMISSIONS = [
  {
    ...
    permissions: {
      ...
      dashboardResStatus: true,
      dashboardResVersion: true,
      dashboardRecoveryOverview: true,
      dashboardRecoveryByProcess: true,
      dashboardRecoveryByModel: true,
      dashboardRecoveryAnalysis: true,
      dashboardRecoveryByCategory: true,
      dashboardUserActivity: true,
      arsAgent: false,
      resourceAgent: false,
      equipmentInfo: false,
      emailTemplate: false,
