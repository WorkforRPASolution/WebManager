<template>
  <div class="flex flex-col gap-4" style="height: calc(100vh - 144px);">
    ...
    <div class="flex items-center justify-between">
      <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Popup Template Management</h1>
...
import PopupTemplateFilterBar from './components/PopupTemplateFilterBar.vue'
import BaseDataGridToolbar from '@/shared/components/BaseDataGridToolbar.vue'
import PopupTemplateGrid from './components/PopupTemplateGrid.vue'
import DeleteConfirmModal from '../equipment-info/components/DeleteConfirmModal.vue'
import HtmlEditorModal from '../email-template/components/HtmlEditorModal.vue'
import PermissionSettingsDialog from '@/shared/components/PermissionSettingsDialog.vue'
import { usePopupTemplateData } from './composables/usePopupTemplateData'
...
// Permission hooks
const { canRead, canWrite, canDelete, isAdmin, refresh: refreshPermissions } = useFeaturePermission('popupTemplate')
