...
// Editable columns (no title field for popup template)
const editableColumns = ['app', 'process', 'model', 'code', 'subcode', 'html']
...
// Column definitions (no title column for popup template)
...
// Paste column order (no title for popup template)
const pasteColumnOrder = ['app', 'process', 'model', 'code', 'subcode', 'html']
